...
const CheckAuth = ({ isAuthenticated, user, children }) => {
  ...
  if (
    isAuthenticated && // ager user nhi login kar liya hai to usko login page yeah ragister page nhi dekhana hai
  ...
  if (
    ...
    // customer ko admin page provide nhi karna hai
  ...
  if (
    ...
    // admin ko shop page provide nhi karna hai
    return <Navigate to="/admin/dashboard" />;
  }
  return <>{children}</>;
};
